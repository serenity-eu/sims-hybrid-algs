...
Get a thumbnail of a full scene from the catalog. Not all data hosts provide thumbnails.
...
```json
{
  ...
  "paths": {
    "/catalog/{host-name}/image/{image-id}/thumbnail": {
      "get": {
        "tags": [
          "Catalog"
        ],
        "summary": "Get a thumbnail",
        "description": "Get a thumbnail of a full scene from the catalog. Not all data hosts provide thumbnails.\n\nThumbnails are small, low-resolution, light-weighted previews of full scenes. For some data hosts, thumbnails can be cropped and rotated compared to quicklooks.\n",
