...
Get information about a specific data product. A data product is a type of imagery with a specific geometric and radiometric processing level and file format.
...
```json
{
  ...
  "paths": {
    "/v2/data-products/{data-product-name}": {
      "get": {
        "tags": [
          "Glossary"
        ],
        "summary": "Get a data product",
        "description": "Get information about a specific data product. A data product is a type of imagery with a specific geometric and radiometric processing level and file format.\n",
        "operationId": "getDataProductV2",
        "parameters": [
          {
            "$ref": "#/components/parameters/DataProductNameInPath"
          }
        ],
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                ...
                "example": {
                  "error": {
                    "code": 404,
                    "message": "Data product with name $dataProductName not found",
                    "details": null
                  }
                }
              }
