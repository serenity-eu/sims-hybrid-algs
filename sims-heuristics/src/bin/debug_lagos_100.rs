...
fn main() {
    ...
    println!("Loading lagos_nigeria_100 instance...");

    // Load the problem
    let instance_path = Path::new("data").join("lagos_nigeria_100.dzn");
    ...
    println!("Running PLS with 30 minute timeout...");
    ...
    let timeout = Duration::from_secs(1800); // 30 minutes for larger instance
