...
`create_residual_problem` builds the decision set as:
- `decision_set = removal_candidates ∩ best_addition_candidates`
...
See [best_unselected_images_with_trackers](sims-heuristics/src/solution_impl/bitset_encoded_solution.rs#L604).

This intersection is a deliberate heuristic:
- It biases repair towards swapping/reintroducing images “near” those removed (and/or within a constrained candidate set), which keeps the residual combinatorics small.
